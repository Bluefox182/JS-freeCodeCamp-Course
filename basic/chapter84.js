...
// Exercise
/* Update the myDog object's name property. Let's change her name from Coder
 to Happy Coder. You can use either dot or bracket notation. */
...
myDog.name = "Happy Coder"; // Answer 1
myDog["name"] = "Happy Coder"; // Answer 2
