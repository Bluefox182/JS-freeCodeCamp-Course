...
using shift() and pop(), but what if we want to remove an element from somewhere in 
the middle? Or remove more than one element at once? Well, that's where splice() 
...
The first two parameters of splice() are integers which represent indexes, or 
