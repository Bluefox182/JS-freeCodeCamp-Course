...
// The console will display the strings Hello, my name is Zodiac Hasbro! and
// I am 56 years old..
...
both in the code and the output. This saves inserting \n within strings. The ${variable}
 syntax used above is a placeholder. Basically, you won't have to use concatenation 
 with the + operator anymore. To add variables to strings, you just drop the variable 
 in a template string and wrap it with ${ and }. Similarly, you can include other 
 expressions in your string literal, for example ${a + b}. This new way of creating 
...
(li) strings. Each list element's text should be one of the array elements from the 
